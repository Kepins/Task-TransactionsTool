...
def valid_transaction_file(tmp_path):
    ...
    transaction_1 = (
        "02"
        + str(fixture.transactions[1].counter).rjust(6)
        + str(fixture.transactions[1].amount).rjust(12)
    ...
    transaction_2 = (
        "02"
        + str(fixture.transactions[2].counter).rjust(6)
        + str(fixture.transactions[2].amount).rjust(12)
    ...
    transaction_3 = (
        "02"
        + str(fixture.transactions[3].counter).rjust(6)
        + str(fixture.transactions[3].amount).rjust(12)
    ...
    footer = (
        "03"
        + str(fixture.total_counter).rjust(6)
        + str(fixture.control_sum).rjust(12)
        + " " * 100
        + "\n"
    )
